...
type CategoryItemProps = {
  category: { name: string; products: number };
  selected: boolean;
...
const CategoryDropdown = ({
  ...
  return (
    <div id="category-filter" className="bg-white shadow-1 rounded-lg">
      <div
        onClick={(e) => {
          e.preventDefault();
        ...
        <div className="flex items-center gap-3">
          ...
          {selectedCategories.length > 0 && (
            <button
              ...
              className="flex items-center justify-center w-5 h-5 rounded-full bg-red hover:bg-red-dark transition-colors"
