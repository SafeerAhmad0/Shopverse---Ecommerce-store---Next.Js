          ...
          <div className="max-w-[330px] w-full">
            ...
            <div className="flex items-center gap-4 mt-7.5">
              <a
                ...
                rel="noopener noreferrer" // it prevents the new page from having access to your original window object (and cuts down on potential tab-napping).
              >
                <svg
          ...
          <div className="flex gap-5 flex-wrap items-center justify-between">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex flex-wrap items-center gap-6">
                ...
                <a href="#" aria-label="payment system with aman">
                  <Image
                    src="/images/payment/payment-03.jpg"
                    alt="aman"
                    width={33}
                    height={22}
                  />
                </a>
                <a href="#" aria-label="payment system with meza">
                  <Image
                    src="/images/payment/payment-04.jpg"
                    alt="meza"
                    width={66}
                    height={22}
                  />
                </a>
                <a href="#" aria-label="payment system with valu">
                  <Image
                    src="/images/payment/payment-05.jpg"
                    alt="valu"
                    width={66}
                    height={22}
                  />
