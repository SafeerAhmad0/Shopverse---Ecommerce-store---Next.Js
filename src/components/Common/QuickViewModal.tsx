...
const QuickViewModal = () => {
  ...
  const handleAddToWishlist = async () => {
    ...
    if (isInWishlist) {
      ...
      dispatch(removeItemFromWishlist(productIdToUse));
              ...
              <div className="flex gap-5">
                ...
                <div className="relative z-1 overflow-hidden flex items-center justify-center w-full sm:min-h-[508px] bg-gray-1 rounded-lg border border-gray-3">
                  <div>
                    ...
                    <Image
                      src={product?.imgs?.previews?.[activePreview] || "/placeholder.png"}
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                >
                  ...
                  >
                    {isInWishlist ? (
                      <path
                        d="M10 17.7084C9.42469 17.7084 8.8949 17.4879 8.43071 17.2166C7.96631 16.9453 7.50807 16.5864 7.0812 16.2499C6.8615 16.0767 6.63051 15.8989 6.39237 15.7155C5.34187 14.9067 4.15241 13.9908 3.18062 12.8966C1.9671 11.5301 1.04169 9.83557 1.04169 7.6143C1.04169 5.35424 2.32061 3.39415 4.16732 2.55002C5.91582 1.75077 8.07331 1.99192 10 3.71573C11.9267 1.99192 14.0842 1.75077 15.8327 2.55002C17.6794 3.39415 18.9584 5.35424 18.9584 7.6143C18.9584 9.83557 18.0329 11.5301 16.8194 12.8966C15.8476 13.9908 14.6582 14.9067 13.6077 15.7155C13.3695 15.8989 13.1385 16.0767 12.9188 16.2499C12.492 16.5864 12.0337 16.9453 11.5693 17.2166C11.1051 17.4879 10.5754 17.7084 10 17.7084Z"
                        fill="#DC2626"
                      />
                    ) : (
                      <path
