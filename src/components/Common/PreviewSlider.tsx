...
const PreviewSliderModal = () => {
  const { closePreviewModal, isModalPreviewOpen, activeProduct,
    activeIndex,
    setActiveIndex, } = usePreviewSlider();
  ...
  const handleNext = useCallback(() => {
    ...
    // sync Swiper when context activeIndex changes
  useEffect(() => {
  ...
  if (!isModalPreviewOpen || !activeProduct) return null;

  const images = activeProduct.imgs?.previews ?? [];
