  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row">
        <div className="relative flex-shrink-0 w-full sm:w-[270px] h-[270px] bg-white flex items-center justify-center border-b sm:border-b-0 sm:border-r border-gray-100 overflow-hidden p-4">
          <div
          ...
          {item.category && (
            <div className="absolute top-2 left-2 bg-blue text-white px-2 py-1 rounded text-xs font-medium">
              {item.category}
            </div>
          )}
          ...
          <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
            ...
            <button
              ...
              className="inline-flex font-medium text-custom-sm py-[7px] px-5 rounded-[5px] bg-blue text-white ease-out duration-200 hover:bg-blue-dark disabled:bg-gray-400 disabled:cursor-not-allowed min-w-[100px]"
            >
              {item.stock === 0 ? 'Out of Stock' : isInCart ? 'Checkout' : 'Add to cart'}
            </button>

            <button
              onClick={() => handleItemToWishList()}
              aria-label="button for favorite select"
              className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:text-red-500"
            >
        ...
        <div className="flex-1 p-6">
          <h3
            className="text-xl font-medium text-gray-900 mb-2 group-hover:text-gray-700 transition-colors"
          ...
          >
            ...
            <span className="text-sm text-gray-500 ml-2">({item.reviews || 32})</span>
          </div>

          <p
            className="text-sm text-gray-600 mb-4 font-light leading-relaxed line-clamp-3"
          ...
          >
            <span className="text-2xl font-light text-gray-900">${item.price}</span>
          </div>
        </div>
      </div>
    </div>
